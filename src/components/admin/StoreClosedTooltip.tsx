...
export function StoreClosedTooltip({ isVisible }: StoreClosedTooltipProps) {
  if (!isVisible) return null;

  return (
    <div className="absolute -bottom-24 left-1/2 -translate-x-1/2 w-72 bg-popover border border-border rounded-lg p-4 shadow-lg z-10">
